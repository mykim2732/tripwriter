...
- AI가 쓴 글처럼 보이는 상투어를 제거합니다. 특히 "이번 포스팅에서는", "소개해드릴게요", "함께 알아볼까요", "완벽한", "최고의", "강력 추천", "놓치지 마세요"를 반복하지 않습니다.
- 반복 문장 구조를 줄이고 문단 첫 문장이 모두 비슷해지지 않도록 바꿉니다.
- 과장 표현은 사용자가 입력한 사실, 사진 분석, 실제 사용감 중심의 담백한 문장으로 낮춥니다.
- 원문에 있는 말투, 문장 길이, 이모지 습관, CTA 습관을 유지하는 것을 디자인보다 우선합니다.
...
- 사진마다 본문 안에 연결 문장을 하나 이상 만들고, caption은 사진에서 확인되는 장면만 짧게 설명합니다.
- 대표사진은 도입 첫인상, 중간 사진은 사용/경험 디테일, 마지막 사진은 마무리 기억 장면 또는 CTA 직전으로 흐름을 잡습니다.
...
- AI 티 나는 문장, 반복 문장, 과장 문구가 있으면 polishedContent와 html 양쪽에서 모두 자연스럽게 제거할 것
