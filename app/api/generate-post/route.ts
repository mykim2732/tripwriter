...
네이버 블로그, 티스토리, 브런치, 인스타그램, 스레드, 워드프레스 등 다양한 플랫폼에서 실제 사람이 직접 작성한 것처럼 자연스러운 글을 작성합니다.
...
- 플랫폼에 맞는 톤과 길이를 반영: naver는 긴 글/소제목/사진 배치/검색 키워드, tistory는 긴 글/정보성/구조화/검색 키워드, threads는 짧고 자연스러운 대화형/댓글과 공감 유도/과하지 않은 이모지 중심
