      ...
      <section className="px-5 pb-8 pt-7">
        ...
        {!loading && !error && isAdmin && (
          <div className="space-y-4">
            ...
            <article className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
              <h2 className="text-base font-black text-slate-950">최근 베타 피드백</h2>
              <p className="mt-2 rounded-2xl bg-slate-50 px-4 py-3 text-sm font-bold leading-6 text-slate-500">현재 피드백은 `/feedback`에서 localStorage mock으로 저장됩니다. 운영 전용 feedback 테이블을 연결하면 별점, 버그 신고, 기능 요청을 이곳에서 볼 수 있어요.</p>
            </article>
          </div>
        )}
      </section>
