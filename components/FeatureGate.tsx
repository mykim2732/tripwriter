  ...
  return (
    <article className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-blue-100">
      <div className="flex items-start gap-3">
        <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-blue-50 text-blue-600"><Lock size={20} /></div>
        <div className="min-w-0 flex-1">
          <h3 className="text-base font-black text-slate-950">{feature}</h3>
          <p className="mt-1 text-sm leading-6 text-slate-500">{requiredPlan.toUpperCase()} 플랜부터 사용할 수 있는 기능이에요.</p>
