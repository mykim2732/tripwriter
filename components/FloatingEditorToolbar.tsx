...
export function FloatingEditorToolbar({
  ...
  return (
    <footer className="sticky bottom-0 z-30 border-t border-slate-100 bg-white/95 pb-[env(safe-area-inset-bottom)] shadow-[0_-10px_30px_rgba(15,23,42,0.04)] backdrop-blur">
